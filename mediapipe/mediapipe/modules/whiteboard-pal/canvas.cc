...
constexpr char FRAME_SIZE_TAG[] = "FRAME_SIZE";
...
class WhiteboardPalCanvasCalculator: public CalculatorBase {
    ...
    public: 
        ...
        absl::Status Open(CalculatorContext* cc) {
            ...
            this->size = cc->InputSidePackets().Tag(FRAME_SIZE_TAG).Get<std::pair<int, int>>();
        ...
        absl::Status Process(CalculatorContext* cc) {
            ...
            // only update the canvas is there are points
